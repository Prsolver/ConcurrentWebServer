...
[CGI](http://www.cs.wisc.edu/test.cgi). To specify more arguments, the `?` and `&`
...
example, [Arguments] (http://www.cs.wisc.edu/test.cgi?x=10&y=20) can be used to send
...
[Common Gateway Interface](https://en.wikipedia.org/wiki/Common_Gateway_Interface); yes, this
